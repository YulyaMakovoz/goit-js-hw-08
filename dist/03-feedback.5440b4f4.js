...
function fillForm() {
    ...
    if (formObject[inputEl.name]) inputEl.value = formObject.email;
    if (formObject[messageEl.name]) messageEl.value = formObject.message;
}
if (localStorage.getItem("feedback-form-state")) fillForm();
